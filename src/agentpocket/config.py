...
def _get_or_create_secret_key() -> str:
    ...
    if env_key:
        return env_key
    key_dir = Path.home() / ".Agent-SaveMark"
    ...
    with FileLock(str(lock_file)):
        ...
        try:
            key_file.chmod(0o600)  # Best effort on Windows, enforced on Unix.
        except OSError:
            pass
        return key
...
class DatabaseSettings(BaseSettings):
    ...
    url: str = "sqlite:///./data/Agent-SaveMark.db"
    echo: bool = False
...
class AuthSettings(BaseSettings):
    ...
    password_hard: str = ""  # Optional emergency override password for login
...
class AISettings(BaseSettings):
    ...
    ollama_tagged_model: str = "llama3.2"
    ollama_summarized_model: str = "llama3.2"
    groq_api_key: str = ""
    groq_tagged_model: str = "llama-3.3-70b-versatile"
    groq_summarized_model: str = "llama-3.3-70b-versatile"
    nvidia_api_key: str = ""
    nvidia_tagged_model: str = "qwen/qwen3.5-397b-a17b"
    nvidia_summarized_model: str = "qwen/qwen3.5-397b-a17b"
    # Custom provider (any OpenAI-compatible or Anthropic-compatible endpoint)
    custom_base_url: str = ""
    custom_api_key: str = ""
    custom_model: str = ""
    custom_tagged_model: str = ""
    custom_summarized_model: str = ""
