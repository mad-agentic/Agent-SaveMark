...
from agentpocket.processors.base import BaseProcessor, ProcessorResult, ProcessorStatus
from agentpocket.processors.registry import register_processor
...
def _try_json_endpoint(url: str) -> dict | None:
    ...
    """
    from agentpocket.processors.base import _is_safe_url
    ...
    try:
        resp = httpx.get(
            json_url,
            headers={
                "User-Agent": "Mozilla/5.0 (compatible; Agent-SaveMark/1.0)",
