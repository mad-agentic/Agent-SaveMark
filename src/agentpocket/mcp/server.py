...
MCP ``AccessToken`` context and delegate to pure functions in :mod:`agentpocket.mcp.tools`.
"""
...
from agentpocket.api.api_token_utils import resolve_token
from agentpocket.db.session import get_engine
from agentpocket.mcp import tools as tools_mod
...
def _build_mcp() -> FastMCP:
    ...
    return FastMCP(
        "Agent-SaveMark",
        instructions=(
            "Agent-SaveMark is the user's personal knowledge base. "
