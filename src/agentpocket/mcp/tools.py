...
from agentpocket.mcp.serializers import (
    collection_brief,
    entity_brief,
...
from agentpocket.models.entity import Entity
from agentpocket.models.entity_relation import EntityRelation
...
def list_collections(
    ...
    if not token.all_collections:
        from agentpocket.models.api_token import ApiTokenCollection
...
def delete_knowledge(
    ...
    from agentpocket.api.items import cascade_delete_item
