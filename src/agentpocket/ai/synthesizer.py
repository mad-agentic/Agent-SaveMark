...
Regeneration rules live in :mod:`agentpocket.workers.enrichment_pipeline`:
...
from agentpocket.ai.factory import get_chat_provider
from agentpocket.ai.llm_cache import get_cached_response, store_cached_response
