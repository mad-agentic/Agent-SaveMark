...
from agentpocket.models.item import ItemRead, KnowledgeItem
from agentpocket.models.note import Note, NoteRead
from agentpocket.models.user import User
from agentpocket.search.filters import parse_filters
...
def semantic_search(
    ...
    try:
        from agentpocket.search.semantic import search_by_text
...
def get_search_filters(
    ...
    from agentpocket.models.base import ItemType
