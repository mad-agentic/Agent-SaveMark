...
from agentpocket.models.base import ItemType, ReadingStatus, SourcePlatform
from agentpocket.models.item import ItemCreate, ItemRead, ItemUpdate, KnowledgeItem
...
def create_item(
    ...
    try:
        from agentpocket.workers.rule_engine import run_rules_for_item
    ...
    try:
        if item.url:
            from agentpocket.workers.fetcher import fetch_and_process_url
            from agentpocket.workers.screenshot import capture_screenshot
...
def cascade_delete_item(db: Session, item: KnowledgeItem) -> None:
    ...
    from agentpocket.models.entity import ItemEntity
    from agentpocket.models.entity_relation import RelationEvidence
...
def archive_item(
    ...
    try:
        from agentpocket.workers.archiver import archive_page
...
def get_related_items(
    ...
    if not item or item.user_id != current_user.id:
        raise HTTPException(status_code=404, detail="Item not found")
    try:
        from agentpocket.ai.connector import find_related
...
def bulk_action(
    ...
    for iid in data.item_ids:
        ...
        if data.action == "archive":
            ...
            from agentpocket.models.enrichment import EnrichmentStage as _ES
            from agentpocket.models.entity import ItemEntity as _IE
            from agentpocket.models.entity_relation import RelationEvidence as _RE
            from agentpocket.models.item_chunk import ItemChunk as _IC
...
def download_item_video(
    ...
    from agentpocket.workers.media_downloader import download_video
...
def media_proxy(
    ...
    from agentpocket.config import get_settings
    from agentpocket.storage.local import LocalStorage
