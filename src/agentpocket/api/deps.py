...
from agentpocket.api.auth_utils import decode_access_token, hash_password
from agentpocket.config import get_settings
from agentpocket.db.session import get_session
...
def _resolve_pat(db: Session, token: str) -> tuple[User, ApiToken] | None:
    ...
    from agentpocket.api.api_token_utils import looks_like_pat, resolve_token, touch_last_used
...
def _resolve_identity(
    ...
    from agentpocket.api.api_token_utils import looks_like_pat
...
def require_pat_editor(pat: ApiToken | None = Depends(get_current_pat)) -> None:
    ...
    from agentpocket.api.api_token_utils import require_editor
...
def require_pat_deletion(pat: ApiToken | None = Depends(get_current_pat)) -> None:
    ...
    from agentpocket.api.api_token_utils import require_deletion
