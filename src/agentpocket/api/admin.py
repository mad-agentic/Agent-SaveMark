...
from agentpocket.api.deps import get_db, get_or_create_settings, require_admin
...
from agentpocket.models.user import User, UserRead
...
def instance_stats(
    ...
    try:
        ...
        out = subprocess.run(
            ["pgrep", "-f", "agentpocket.workers.huey_worker"],
