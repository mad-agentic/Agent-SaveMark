...
from agentpocket.models.base import ItemType, SourcePlatform
...
def export_bookmarks(
    ...
    if format == "json":
        ...
        return StreamingResponse(
            ...
            headers={"Content-Disposition": "attachment; filename=Agent-SaveMark-export.json"},
        )
        ...
        lines = [
            ...
            '<TITLE>Agent-SaveMark Bookmarks</TITLE>',
            '<H1>Agent-SaveMark Bookmarks</H1>',
            '<DL><p>',
        ]
        for i in items:
        ...
        return StreamingResponse(
            ...
            headers={"Content-Disposition": "attachment; filename=Agent-SaveMark-bookmarks.html"},
        )
        ...
        return StreamingResponse(
            ...
            headers={"Content-Disposition": "attachment; filename=Agent-SaveMark-export.csv"},
        )

    elif format == "markdown":
        lines = ["# Agent-SaveMark Export\n"]
        for i in items:
        ...
        return StreamingResponse(
            ...
            headers={"Content-Disposition": "attachment; filename=Agent-SaveMark-export.md"},
        )
