...
from agentpocket.models.note import Note, NoteCreate, NoteRead, NoteUpdate
from agentpocket.models.note_tag import NoteTag
from agentpocket.models.tag import Tag, TagRead
...
def create_note(
    ...
    db.refresh(note)
    try:
        from agentpocket.search.sqlite_fts import index_note
        index_note(db, note)
    except Exception:
        pass  # Non-critical
    return note
...
def search_notes(
    ...
    from agentpocket.search.sqlite_fts import search_notes as fts_search_notes
...
def delete_note(
    ...
    try:
        from agentpocket.config import get_settings as _get_settings
        _s = _get_settings()
...
def summarize_note_endpoint(
    ...
    try:
        from agentpocket.ai.summarizer import summarize_note
...
def generate_note_title(
    ...
    try:
        from agentpocket.ai.title_generator import generate_title
