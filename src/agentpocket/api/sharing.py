...
from agentpocket.models.share import Share, ShareRecipient, ShareRecipientRole, ShareType
from agentpocket.models.tag import ItemTag, Tag
from agentpocket.models.user import User
from agentpocket.sharing.share_manager import (
    add_recipient,
    create_share,
    revoke_share,
...
def share_history(
    ...
    for share in shares:
        ...
        if share.item_id:
            ...
            from agentpocket.models.collection import Collection
...
def get_public_share(
    ...
    from agentpocket.api.rate_limit import check_rate_limit, record_attempt

    client_ip = request.client.host if request.client else "unknown"
    check_rate_limit(db, key=client_ip, action="public_token", max_attempts=5, window_seconds=60, lockout_minutes=2)
    record_attempt(db, key=client_ip, action="public_token")
