...
def enrich_item(item_id: str, user_id: str) -> dict:
    ...
    with Session(engine) as db:
        ...
        try:
            from agentpocket.ai.hierarchy import apply_hierarchy
        ...
        try:
            ...
            from agentpocket.search.semantic import add_embedding
        ...
        try:
            ...
            from agentpocket.models.item_chunk import ItemChunk
            from agentpocket.search.semantic import add_chunk_embedding
            item_chunks = db.exec(
