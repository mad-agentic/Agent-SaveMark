    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <header className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-2">
          ...
          <span className="font-bold text-sky-600">Agent</span>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-6 mt-12">
        <div className="max-w-3xl mx-auto px-4 text-center text-xs text-gray-400">
          Shared via <span className="font-semibold text-sky-600">Agent-SaveMark</span> - AI-powered personal knowledge base
        </div>
      </footer>
    </div>
  );
