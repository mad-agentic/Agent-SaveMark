...
# ═══════════════════════════════════════════════════════════════════
# Agent-SaveMark — Application Management Script
#
...
services_up() {
    ...
    if [ ${#services[@]} -eq 0 ]; then
        ...
        load_env
        local db_url="${FDP_DATABASE__URL:-sqlite:///./data/Agent-SaveMark.db}"
...
do_start() {
    ...
    case "$profile" in
        sqlite)
            export FDP_DATABASE__URL="sqlite:///./data/Agent-SaveMark.db"
