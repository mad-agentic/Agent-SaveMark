...
Add end-to-end integration so external LLM agents (Claude Desktop, Cursor, Claude Code, Codex, etc.) can treat a Agent-SaveMark instance as persistent memory via the Model Context Protocol.
...
- [x] Update `README.md`: "Using Agent-SaveMark as an MCP Server" section with PAT creation, Claude Desktop / Cursor / Raw JSON snippets, tool list, synthesis overview
